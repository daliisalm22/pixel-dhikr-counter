document.addEventListener("DOMContentLoaded", () => {
    ...
    let totalDhikrs = parseInt(localStorage.getItem('totalDhikrs')) || 0;
    let streak = parseInt(localStorage.getItem('dhikrStreak')) || 0;
    ...
    if (lastActiveDate !== todayStr) {
        ...
        localStorage.setItem('dhikrStreak', streak);
    ...
    counterBtn.addEventListener('click', () => {
        ...
        totalDhikrs++;
        localStorage.setItem('totalDhikrs', totalDhikrs);
        if (totalDisplay) totalDisplay.textContent = totalDhikrs;
